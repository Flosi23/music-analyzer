...
export type PlayerErrorReasons =
	(typeof PlayerErrorReasons)[keyof typeof PlayerErrorReasons];
 ...
 * @export
 */
export const AlbumsApiAxiosParamCreator = function (
	...
	return {
		...
		getAnAlbum: async (
			...
			const localVarPath = `/albums/{id}`.replace(
				`{${"id"}}`,
		...
		getAnAlbumsTracks: async (
			...
			const localVarPath = `/albums/{id}/tracks`.replace(
				`{${"id"}}`,
				encodeURIComponent(String(id)),
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		...
		getAnArtistsAlbums: async (
			...
			const localVarPath = `/artists/{id}/albums`.replace(
				`{${"id"}}`,
				encodeURIComponent(String(id)),
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
	...
	return {
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.checkUsersSavedAlbums(
					ids,
					options,
				);
		...
		async getAnAlbum(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<AlbumObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getAnAlbum(id, market, options);
			return createRequestFunction(
				localVarAxiosArgs,
				globalAxios,
				BASE_PATH,
		...
		async getAnAlbumsTracks(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<PagingSimplifiedTrackObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getAnAlbumsTracks(
					id,
					market,
					limit,
					offset,
		...
		async getAnArtistsAlbums(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<PagingArtistDiscographyAlbumObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getAnArtistsAlbums(
					id,
					includeGroups,
					market,
					limit,
		...
		async getMultipleAlbums(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<GetMultipleAlbums200Response>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getMultipleAlbums(
					ids,
					market,
					options,
				);
		...
		async getNewReleases(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<GetNewReleases200Response>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getNewReleases(
					country,
					limit,
					offset,
					options,
		...
		async getUsersSavedAlbums(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<PagingSavedAlbumObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getUsersSavedAlbums(
					limit,
					offset,
					market,
					options,
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.removeAlbumsUser(
					ids,
					requestBody,
					options,
				);
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.saveAlbumsUser(
					ids,
					requestBody,
					options,
				);
 ...
 * @export
 */
export const AlbumsApiFactory = function (
	configuration?: Configuration,
	basePath?: string,
	axios?: AxiosInstance,
) {
	...
	return {
		...
		checkUsersSavedAlbums(
			...
			return localVarFp
				.checkUsersSavedAlbums(ids, options)
		...
		getAnAlbumsTracks(
			...
			return localVarFp
				.getAnAlbumsTracks(id, market, limit, offset, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get Spotify catalog information about an artist\'s albums.
		...
		getMultipleAlbums(
			...
			return localVarFp
				.getMultipleAlbums(ids, market, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get a list of new album releases featured in Spotify (shown, for example, on a Spotify player’s “Browse” tab).
		...
		getNewReleases(
			...
			return localVarFp
				.getNewReleases(country, limit, offset, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get a list of the albums saved in the current Spotify user\'s \'Your Music\' library.
		...
		getUsersSavedAlbums(
			...
			return localVarFp
				.getUsersSavedAlbums(limit, offset, market, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Remove one or more albums from the current user\'s \'Your Music\' library.
		...
		removeAlbumsUser(
			...
			return localVarFp
				.removeAlbumsUser(ids, requestBody, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Save one or more albums to the current user\'s \'Your Music\' library.
		...
		saveAlbumsUser(
			...
			return localVarFp
				.saveAlbumsUser(ids, requestBody, options)
				.then((request) => request(axios, basePath));
		},
	};
};
...
export class AlbumsApi extends BaseAPI {
	...
	public checkUsersSavedAlbums(ids: string, options?: AxiosRequestConfig) {
		return AlbumsApiFp(this.configuration)
			.checkUsersSavedAlbums(ids, options)
 ...
 * @export
 */
export const ArtistsApiAxiosParamCreator = function (
	configuration?: Configuration,
) {
	return {
		/**
		 ...
		 * @throws {RequiredError}
		 */
		followArtistsUsers: async (
			type: FollowArtistsUsersTypeEnum,
			ids: string,
			requestBody?: { [key: string]: any },
			options: AxiosRequestConfig = {},
		): Promise<RequestArgs> => {
		...
		getAnArtist: async (
			...
			const localVarPath = `/artists/{id}`.replace(
				`{${"id"}}`,
				encodeURIComponent(String(id)),
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		 ...
		 * @throws {RequiredError}
		 */
		getAnArtistsRelatedArtists: async (
			id: string,
			options: AxiosRequestConfig = {},
		): Promise<RequestArgs> => {
			// verify required parameter 'id' is not null or undefined
			assertParamExists("getAnArtistsRelatedArtists", "id", id);
			const localVarPath = `/artists/{id}/related-artists`.replace(
				`{${"id"}}`,
				encodeURIComponent(String(id)),
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		...
		getAnArtistsTopTracks: async (
			...
			const localVarPath = `/artists/{id}/top-tracks`.replace(
				`{${"id"}}`,
				encodeURIComponent(String(id)),
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		 ...
		 * @throws {RequiredError}
		 */
		unfollowArtistsUsers: async (
			type: UnfollowArtistsUsersTypeEnum,
			ids: string,
			requestBody?: { [key: string]: any },
			options: AxiosRequestConfig = {},
		): Promise<RequestArgs> => {
...
export const ArtistsApiFp = function (configuration?: Configuration) {
	const localVarAxiosParamCreator =
		ArtistsApiAxiosParamCreator(configuration);
	return {
		/**
		 * Check to see if the current user is following one or more artists or other Spotify users.
		 * @summary Check If User Follows Artists or Users
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.checkCurrentUserFollows(
					type,
					ids,
					options,
				);
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.followArtistsUsers(
					type,
					ids,
					requestBody,
					options,
		...
		async getAnArtist(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<ArtistObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getAnArtist(id, options);
			return createRequestFunction(
				localVarAxiosArgs,
				globalAxios,
				BASE_PATH,
		...
		async getAnArtistsRelatedArtists(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<GetMultipleArtists200Response>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getAnArtistsRelatedArtists(
					id,
					options,
				);
			return createRequestFunction(
		...
		async getAnArtistsTopTracks(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<GetAnArtistsTopTracks200Response>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getAnArtistsTopTracks(
					id,
					market,
					options,
				);
		...
		async getFollowed(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<GetFollowed200Response>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getFollowed(
					type,
					after,
					limit,
					options,
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getMultipleArtists(
					ids,
					options,
				);
			return createRequestFunction(
		...
		async getUsersTopArtists(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<PagingArtistObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getUsersTopArtists(
					timeRange,
					limit,
					offset,
					options,
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.unfollowArtistsUsers(
					type,
					ids,
					requestBody,
					options,
 ...
 * @export
 */
export const ArtistsApiFactory = function (
	configuration?: Configuration,
	basePath?: string,
	axios?: AxiosInstance,
) {
	...
	return {
		...
		checkCurrentUserFollows(
			...
			return localVarFp
				.checkCurrentUserFollows(type, ids, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Add the current user as a follower of one or more artists or other Spotify users.
		...
		followArtistsUsers(
			...
			return localVarFp
				.followArtistsUsers(type, ids, requestBody, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get Spotify catalog information for a single artist identified by their unique Spotify ID.
		...
		getAnArtistsTopTracks(
			...
			return localVarFp
				.getAnArtistsTopTracks(id, market, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get the current user\'s followed artists.
		...
		getFollowed(
			...
			return localVarFp
				.getFollowed(type, after, limit, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get Spotify catalog information for several artists based on their Spotify IDs.
		...
		getMultipleArtists(
			...
			return localVarFp
				.getMultipleArtists(ids, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get the current user\'s top artists based on calculated affinity.
		...
		getUsersTopArtists(
			...
			return localVarFp
				.getUsersTopArtists(timeRange, limit, offset, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Remove the current user as a follower of one or more artists or other Spotify users.
		...
		unfollowArtistsUsers(
			...
			return localVarFp
				.unfollowArtistsUsers(type, ids, requestBody, options)
				.then((request) => request(axios, basePath));
		},
	};
};
...
export class ArtistsApi extends BaseAPI {
	...
	public checkCurrentUserFollows(
		...
		return ArtistsApiFp(this.configuration)
			.checkCurrentUserFollows(type, ids, options)
			.then((request) => request(this.axios, this.basePath));
	}
...
export type FollowArtistsUsersTypeEnum =
	(typeof FollowArtistsUsersTypeEnum)[keyof typeof FollowArtistsUsersTypeEnum];
/**
 * @export
 */
 ...
 * @export
 */
export const AudiobooksApiAxiosParamCreator = function (
	configuration?: Configuration,
) {
	return {
		/**
		 ...
		 * @throws {RequiredError}
		 */
		checkUsersSavedAudiobooks: async (
			ids: string,
			options: AxiosRequestConfig = {},
		): Promise<RequestArgs> => {
			// verify required parameter 'ids' is not null or undefined
		...
		getAnAudiobook: async (
			...
			const localVarPath = `/audiobooks/{id}`.replace(
				`{${"id"}}`,
				encodeURIComponent(String(id)),
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		...
		getAudiobookChapters: async (
			...
			const localVarPath = `/audiobooks/{id}/chapters`.replace(
				`{${"id"}}`,
				encodeURIComponent(String(id)),
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const AudiobooksApiFp = function (configuration?: Configuration) {
	const localVarAxiosParamCreator =
		AudiobooksApiAxiosParamCreator(configuration);
	return {
		/**
		 * Check if one or more audiobooks are already saved in the current Spotify user\'s library.
		 * @summary Check User\'s Saved Audiobooks
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.checkUsersSavedAudiobooks(
					ids,
					options,
				);
			return createRequestFunction(
		...
		async getAnAudiobook(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<AudiobookObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getAnAudiobook(
					id,
					market,
					options,
				);
		...
		async getAudiobookChapters(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<PagingSimplifiedChapterObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getAudiobookChapters(
					id,
					market,
					limit,
					offset,
		...
		async getMultipleAudiobooks(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<GetMultipleAudiobooks200Response>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getMultipleAudiobooks(
					ids,
					market,
					options,
				);
		...
		async getUsersSavedAudiobooks(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<PagingSavedAudiobookObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getUsersSavedAudiobooks(
					limit,
					offset,
					options,
				);
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.removeAudiobooksUser(
					ids,
					options,
				);
			return createRequestFunction(
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.saveAudiobooksUser(
					ids,
					options,
				);
			return createRequestFunction(
 ...
 * @export
 */
export const AudiobooksApiFactory = function (
	configuration?: Configuration,
	basePath?: string,
	axios?: AxiosInstance,
) {
	...
	return {
		...
		checkUsersSavedAudiobooks(
			...
			return localVarFp
				.checkUsersSavedAudiobooks(ids, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get Spotify catalog information for a single audiobook.<br /> **Note: Audiobooks are only available for the US, UK, Ireland, New Zealand and Australia markets.**
		...
		getAnAudiobook(
			...
			return localVarFp
				.getAnAudiobook(id, market, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get Spotify catalog information about an audiobook\'s chapters.<br /> **Note: Audiobooks are only available for the US, UK, Ireland, New Zealand and Australia markets.**
		...
		getAudiobookChapters(
			...
			return localVarFp
				.getAudiobookChapters(id, market, limit, offset, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get Spotify catalog information for several audiobooks identified by their Spotify IDs.<br /> **Note: Audiobooks are only available for the US, UK, Ireland, New Zealand and Australia markets.**
		...
		getMultipleAudiobooks(
			...
			return localVarFp
				.getMultipleAudiobooks(ids, market, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get a list of the audiobooks saved in the current Spotify user\'s \'Your Music\' library.
		...
		getUsersSavedAudiobooks(
			...
			return localVarFp
				.getUsersSavedAudiobooks(limit, offset, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Remove one or more audiobooks from the Spotify user\'s library.
		...
		removeAudiobooksUser(ids: string, options?: any): AxiosPromise<void> {
			return localVarFp
				.removeAudiobooksUser(ids, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Save one or more audiobooks to the current Spotify user\'s library.
		...
		saveAudiobooksUser(ids: string, options?: any): AxiosPromise<void> {
			return localVarFp
				.saveAudiobooksUser(ids, options)
				.then((request) => request(axios, basePath));
		},
	};
};
...
export class AudiobooksApi extends BaseAPI {
	...
	public checkUsersSavedAudiobooks(
		...
		return AudiobooksApiFp(this.configuration)
			.checkUsersSavedAudiobooks(ids, options)
			.then((request) => request(this.axios, this.basePath));
	}
...
export const CategoriesApiAxiosParamCreator = function (
	...
	return {
		...
		getACategoriesPlaylists: async (
			...
			const localVarPath =
				`/browse/categories/{category_id}/playlists`.replace(
					`{${"category_id"}}`,
		...
		getACategory: async (
			...
			const localVarPath = `/browse/categories/{category_id}`.replace(
				`{${"category_id"}}`,
				encodeURIComponent(String(categoryId)),
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
	...
	return {
		...
		async getACategoriesPlaylists(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<PagingFeaturedPlaylistObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getACategoriesPlaylists(
					categoryId,
					country,
					limit,
					offset,
		...
		async getACategory(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<CategoryObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getACategory(
					categoryId,
					country,
					locale,
					options,
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getCategories(
					country,
					locale,
					limit,
					offset,
...
export const CategoriesApiFactory = function (
	...
	return {
		...
		getACategory(
			...
			return localVarFp
				.getACategory(categoryId, country, locale, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get a list of categories used to tag items in Spotify (on, for example, the Spotify player’s “Browse” tab).
		...
		getCategories(
			...
			return localVarFp
				.getCategories(country, locale, limit, offset, options)
				.then((request) => request(axios, basePath));
		},
	};
};
...
export class CategoriesApi extends BaseAPI {
	 ...
	 */
	public getACategoriesPlaylists(
		categoryId: string,
		country?: string,
		limit?: number,
		offset?: number,
 ...
 * @export
 */
export const ChaptersApiAxiosParamCreator = function (
	configuration?: Configuration,
) {
	return {
		/**
		...
		getAChapter: async (
			...
			const localVarPath = `/chapters/{id}`.replace(
				`{${"id"}}`,
				encodeURIComponent(String(id)),
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const ChaptersApiFp = function (configuration?: Configuration) {
	const localVarAxiosParamCreator =
		ChaptersApiAxiosParamCreator(configuration);
	return {
		/**
		 * Get Spotify catalog information for a single chapter.<br /> **Note: Chapters are only available for the US, UK, Ireland, New Zealand and Australia markets.**
		 * @summary Get a Chapter
		...
		async getAChapter(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<ChapterObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getAChapter(
					id,
					market,
					options,
				);
		...
		async getSeveralChapters(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<GetSeveralChapters200Response>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getSeveralChapters(
					ids,
					market,
					options,
				);
 ...
 * @export
 */
export const ChaptersApiFactory = function (
	configuration?: Configuration,
	basePath?: string,
	axios?: AxiosInstance,
) {
	...
	return {
		...
		getSeveralChapters(
			...
			return localVarFp
				.getSeveralChapters(ids, market, options)
				.then((request) => request(axios, basePath));
		},
	};
};
...
export class ChaptersApi extends BaseAPI {
	...
	public getAChapter(
		...
		return ChaptersApiFp(this.configuration)
			.getAChapter(id, market, options)
			.then((request) => request(this.axios, this.basePath));
	}
 ...
 * @export
 */
export const EpisodesApiAxiosParamCreator = function (
	configuration?: Configuration,
) {
	return {
		/**
		...
		getAnEpisode: async (
			...
			const localVarPath = `/episodes/{id}`.replace(
				`{${"id"}}`,
				encodeURIComponent(String(id)),
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const EpisodesApiFp = function (configuration?: Configuration) {
	const localVarAxiosParamCreator =
		EpisodesApiAxiosParamCreator(configuration);
	return {
		/**
		 * Check if one or more episodes is already saved in the current Spotify user\'s \'Your Episodes\' library.<br/> This API endpoint is in __beta__ and could change without warning. Please share any feedback that you have, or issues that you discover, in our [developer community forum](https://community.spotify.com/t5/Spotify-for-Developers/bd-p/Spotify_Developer)..
		 * @summary Check User\'s Saved Episodes
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.checkUsersSavedEpisodes(
					ids,
					options,
				);
			return createRequestFunction(
		...
		async getAShowsEpisodes(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<PagingSimplifiedEpisodeObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getAShowsEpisodes(
					id,
					market,
					limit,
					offset,
		...
		async getAnEpisode(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<EpisodeObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getAnEpisode(
					id,
					market,
					options,
				);
		...
		async getMultipleEpisodes(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<GetMultipleEpisodes200Response>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getMultipleEpisodes(
					ids,
					market,
					options,
				);
		...
		async getUsersSavedEpisodes(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<PagingSavedEpisodeObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getUsersSavedEpisodes(
					market,
					limit,
					offset,
					options,
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.removeEpisodesUser(
					ids,
					requestBody,
					options,
				);
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.saveEpisodesUser(
					ids,
					requestBody,
					options,
				);
 ...
 * @export
 */
export const EpisodesApiFactory = function (
	configuration?: Configuration,
	basePath?: string,
	axios?: AxiosInstance,
) {
	...
	return {
		...
		checkUsersSavedEpisodes(
			...
			return localVarFp
				.checkUsersSavedEpisodes(ids, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get Spotify catalog information about an show’s episodes. Optional parameters can be used to limit the number of episodes returned.
		...
		getAShowsEpisodes(
			...
			return localVarFp
				.getAShowsEpisodes(id, market, limit, offset, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get Spotify catalog information for a single episode identified by its unique Spotify ID.
		...
		getAnEpisode(
			...
			return localVarFp
				.getAnEpisode(id, market, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get Spotify catalog information for several episodes based on their Spotify IDs.
		...
		getMultipleEpisodes(
			...
			return localVarFp
				.getMultipleEpisodes(ids, market, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get a list of the episodes saved in the current Spotify user\'s library.<br/> This API endpoint is in __beta__ and could change without warning. Please share any feedback that you have, or issues that you discover, in our [developer community forum](https://community.spotify.com/t5/Spotify-for-Developers/bd-p/Spotify_Developer).
		...
		getUsersSavedEpisodes(
			...
			return localVarFp
				.getUsersSavedEpisodes(market, limit, offset, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Remove one or more episodes from the current user\'s library.<br/> This API endpoint is in __beta__ and could change without warning. Please share any feedback that you have, or issues that you discover, in our [developer community forum](https://community.spotify.com/t5/Spotify-for-Developers/bd-p/Spotify_Developer).
		...
		removeEpisodesUser(
			...
			return localVarFp
				.removeEpisodesUser(ids, requestBody, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Save one or more episodes to the current user\'s library.<br/> This API endpoint is in __beta__ and could change without warning. Please share any feedback that you have, or issues that you discover, in our [developer community forum](https://community.spotify.com/t5/Spotify-for-Developers/bd-p/Spotify_Developer).
		...
		saveEpisodesUser(
			...
			return localVarFp
				.saveEpisodesUser(ids, requestBody, options)
				.then((request) => request(axios, basePath));
		},
	};
};
...
export class EpisodesApi extends BaseAPI {
	...
	public checkUsersSavedEpisodes(ids: string, options?: AxiosRequestConfig) {
		return EpisodesApiFp(this.configuration)
			.checkUsersSavedEpisodes(ids, options)
			.then((request) => request(this.axios, this.basePath));
	}
	...
	return {
		...
		async getRecommendationGenres(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<GetRecommendationGenres200Response>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getRecommendationGenres(
					options,
				);
			return createRequestFunction(
				localVarAxiosArgs,
...
export const GenresApiFactory = function (
	...
	return {
		...
		getRecommendationGenres(
			...
			return localVarFp
				.getRecommendationGenres(options)
				.then((request) => request(axios, basePath));
		},
	};
};
 ...
 * @export
 */
export const LibraryApiAxiosParamCreator = function (
	configuration?: Configuration,
) {
	return {
		/**
		...
		changePlaylistDetails: async (
			...
			const localVarPath = `/playlists/{playlist_id}`.replace(
				`{${"playlist_id"}}`,
		...
		createPlaylist: async (
			...
			const localVarPath = `/users/{user_id}/playlists`.replace(
				`{${"user_id"}}`,
		 ...
		 * @throws {RequiredError}
		 */
		getAListOfCurrentUsersPlaylists: async (
			limit?: number,
			offset?: number,
			options: AxiosRequestConfig = {},
		): Promise<RequestArgs> => {
...
export const LibraryApiFp = function (configuration?: Configuration) {
	const localVarAxiosParamCreator =
		LibraryApiAxiosParamCreator(configuration);
	return {
		/**
		 * Change a playlist\'s name and public/private state. (The user must, of course, own the playlist.)
		 * @summary Change Playlist Details
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.changePlaylistDetails(
					playlistId,
					requestBody,
					options,
				);
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.checkUsersSavedShows(
					ids,
					options,
				);
			return createRequestFunction(
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.checkUsersSavedTracks(
					ids,
					options,
				);
			return createRequestFunction(
		...
		async createPlaylist(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<PlaylistObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.createPlaylist(
					userId,
					requestBody,
					options,
				);
		...
		async getAListOfCurrentUsersPlaylists(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<PagingPlaylistObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getAListOfCurrentUsersPlaylists(
					limit,
					offset,
					options,
				);
		...
		async getUsersSavedShows(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<PagingSavedShowObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getUsersSavedShows(
					limit,
					offset,
					options,
				);
		...
		async getUsersSavedTracks(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<PagingSavedTrackObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getUsersSavedTracks(
					market,
					limit,
					offset,
					options,
		...
		async getUsersTopTracks(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<PagingTrackObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getUsersTopTracks(
					timeRange,
					limit,
					offset,
					options,
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.removeShowsUser(
					ids,
					market,
					saveShowsUserRequest,
					options,
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.removeTracksUser(
					ids,
					requestBody,
					options,
				);
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.saveShowsUser(
					ids,
					saveShowsUserRequest,
					options,
				);
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.saveTracksUser(
					ids,
					requestBody,
					options,
				);
...
export const LibraryApiFactory = function (
	...
	return {
		...
		changePlaylistDetails(
			...
			return localVarFp
				.changePlaylistDetails(playlistId, requestBody, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Check to see if the current user is following one or more artists or other Spotify users.
		...
		checkUsersSavedShows(
			...
			return localVarFp
				.checkUsersSavedShows(ids, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Check if one or more tracks is already saved in the current Spotify user\'s \'Your Music\' library.
		...
		checkUsersSavedTracks(
			...
			return localVarFp
				.checkUsersSavedTracks(ids, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Create a playlist for a Spotify user. (The playlist will be empty until you [add tracks](/documentation/web-api/reference/add-tracks-to-playlist).)
		...
		createPlaylist(
			...
			return localVarFp
				.createPlaylist(userId, requestBody, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Add the current user as a follower of one or more artists or other Spotify users.
		...
		getAListOfCurrentUsersPlaylists(
			...
			return localVarFp
				.getAListOfCurrentUsersPlaylists(limit, offset, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get the current user\'s followed artists.
		...
		getUsersSavedShows(
			...
			return localVarFp
				.getUsersSavedShows(limit, offset, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get a list of the songs saved in the current Spotify user\'s \'Your Music\' library.
		...
		getUsersSavedTracks(
			...
			return localVarFp
				.getUsersSavedTracks(market, limit, offset, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get the current user\'s top artists based on calculated affinity.
		...
		getUsersTopTracks(
			...
			return localVarFp
				.getUsersTopTracks(timeRange, limit, offset, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Remove one or more albums from the current user\'s \'Your Music\' library.
		...
		removeShowsUser(
			...
			return localVarFp
				.removeShowsUser(ids, market, saveShowsUserRequest, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Remove one or more tracks from the current user\'s \'Your Music\' library.
		...
		removeTracksUser(
			...
			return localVarFp
				.removeTracksUser(ids, requestBody, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Save one or more albums to the current user\'s \'Your Music\' library.
		...
		saveShowsUser(
			...
			return localVarFp
				.saveShowsUser(ids, saveShowsUserRequest, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Save one or more tracks to the current user\'s \'Your Music\' library.
		...
		saveTracksUser(
			...
			return localVarFp
				.saveTracksUser(ids, requestBody, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Remove the current user as a follower of one or more artists or other Spotify users.
...
export type UnfollowArtistsUsersTypeEnum =
	(typeof UnfollowArtistsUsersTypeEnum)[keyof typeof UnfollowArtistsUsersTypeEnum];

/**
 * MarketsApi - axios parameter creator
 * @export
 */
export const MarketsApiAxiosParamCreator = function (
	configuration?: Configuration,
) {
	return {
		/**
...
export const MarketsApiFp = function (configuration?: Configuration) {
	const localVarAxiosParamCreator =
		MarketsApiAxiosParamCreator(configuration);
	return {
		/**
		 * Get the list of markets where Spotify is available.
		 * @summary Get Available Markets
		...
		async getAvailableMarkets(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<GetAvailableMarkets200Response>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getAvailableMarkets(options);
			return createRequestFunction(
				localVarAxiosArgs,
				globalAxios,
				BASE_PATH,
...
export class MarketsApi extends BaseAPI {
	...
	public getAvailableMarkets(options?: AxiosRequestConfig) {
		return MarketsApiFp(this.configuration)
			.getAvailableMarkets(options)
			.then((request) => request(this.axios, this.basePath));
	}
}
...
export const PlayerApiAxiosParamCreator = function (
	...
	return {
		 ...
		 * @throws {RequiredError}
		 */
		getAUsersAvailableDevices: async (
			options: AxiosRequestConfig = {},
		): Promise<RequestArgs> => {
		 ...
		 * @throws {RequiredError}
		 */
		getInformationAboutTheUsersCurrentPlayback: async (
			market?: string,
		 ...
		 * @throws {RequiredError}
		 */
		getTheUsersCurrentlyPlayingTrack: async (
			market?: string,
			additionalTypes?: string,
			options: AxiosRequestConfig = {},
		): Promise<RequestArgs> => {
		 ...
		 * @throws {RequiredError}
		 */
		setRepeatModeOnUsersPlayback: async (
			state: string,
			deviceId?: string,
			options: AxiosRequestConfig = {},
		): Promise<RequestArgs> => {
		 ...
		 * @throws {RequiredError}
		 */
		setVolumeForUsersPlayback: async (
		 ...
		 * @throws {RequiredError}
		 */
		skipUsersPlaybackToNextTrack: async (
			deviceId?: string,
			options: AxiosRequestConfig = {},
		): Promise<RequestArgs> => {
		 ...
		 * @throws {RequiredError}
		 */
		skipUsersPlaybackToPreviousTrack: async (
			deviceId?: string,
			options: AxiosRequestConfig = {},
		): Promise<RequestArgs> => {
		 ...
		 * @throws {RequiredError}
		 */
		toggleShuffleForUsersPlayback: async (
			state: boolean,
			deviceId?: string,
			options: AxiosRequestConfig = {},
		): Promise<RequestArgs> => {
...
export const PlayerApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.addToQueue(
					uri,
					deviceId,
					options,
				);
		...
		async getAUsersAvailableDevices(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<DevicesObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getAUsersAvailableDevices(
					options,
				);
			return createRequestFunction(
				localVarAxiosArgs,
		...
		async getInformationAboutTheUsersCurrentPlayback(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<CurrentlyPlayingContextObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getInformationAboutTheUsersCurrentPlayback(
					market,
					additionalTypes,
					options,
				);
		...
		async getQueue(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<QueueObject>
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.getQueue(
				options,
			);
			return createRequestFunction(
				localVarAxiosArgs,
		...
		async getRecentlyPlayed(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<CursorPagingPlayHistoryObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getRecentlyPlayed(
					limit,
					after,
					before,
					options,
		...
		async getTheUsersCurrentlyPlayingTrack(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<CurrentlyPlayingObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getTheUsersCurrentlyPlayingTrack(
					market,
					additionalTypes,
					options,
				);
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.pauseAUsersPlayback(
					deviceId,
					options,
				);
			return createRequestFunction(
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.seekToPositionInCurrentlyPlayingTrack(
					positionMs,
					deviceId,
					options,
				);
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.setRepeatModeOnUsersPlayback(
					state,
					deviceId,
					options,
				);
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.setVolumeForUsersPlayback(
					volumePercent,
					deviceId,
					options,
				);
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.skipUsersPlaybackToNextTrack(
					deviceId,
					options,
				);
			return createRequestFunction(
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.skipUsersPlaybackToPreviousTrack(
					deviceId,
					options,
				);
			return createRequestFunction(
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.startAUsersPlayback(
					deviceId,
					requestBody,
					options,
				);
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.toggleShuffleForUsersPlayback(
					state,
					deviceId,
					options,
				);
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.transferAUsersPlayback(
					requestBody,
					options,
				);
			return createRequestFunction(
...
export const PlayerApiFactory = function (
	...
	return {
		...
		addToQueue(
			...
			return localVarFp
				.addToQueue(uri, deviceId, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get information about a user’s available devices.
		...
		getAUsersAvailableDevices(options?: any): AxiosPromise<DevicesObject> {
			return localVarFp
				.getAUsersAvailableDevices(options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get information about the user’s current playback state, including track or episode, progress, and active device.
		...
		getRecentlyPlayed(
			...
			return localVarFp
				.getRecentlyPlayed(limit, after, before, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get the object currently being played on the user\'s Spotify account.
		...
		pauseAUsersPlayback(
			...
			return localVarFp
				.pauseAUsersPlayback(deviceId, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Seeks to the given position in the user’s currently playing track.
		...
		setRepeatModeOnUsersPlayback(
			...
			return localVarFp
				.setRepeatModeOnUsersPlayback(state, deviceId, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Set the volume for the user’s current playback device.
		...
		setVolumeForUsersPlayback(
			...
			return localVarFp
				.setVolumeForUsersPlayback(volumePercent, deviceId, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Skips to next track in the user’s queue.
		...
		skipUsersPlaybackToNextTrack(
			...
			return localVarFp
				.skipUsersPlaybackToNextTrack(deviceId, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Skips to previous track in the user’s queue.
		...
		skipUsersPlaybackToPreviousTrack(
			...
			return localVarFp
				.skipUsersPlaybackToPreviousTrack(deviceId, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Start a new context or resume current playback on the user\'s active device.
		...
		startAUsersPlayback(
			...
			return localVarFp
				.startAUsersPlayback(deviceId, requestBody, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Toggle shuffle on or off for user’s playback.
		...
		toggleShuffleForUsersPlayback(
			...
			return localVarFp
				.toggleShuffleForUsersPlayback(state, deviceId, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Transfer playback to a new device and determine if it should start playing.
		...
		transferAUsersPlayback(
			...
			return localVarFp
				.transferAUsersPlayback(requestBody, options)
				.then((request) => request(axios, basePath));
		},
	};
};
...
export class PlayerApi extends BaseAPI {
	...
	public getTheUsersCurrentlyPlayingTrack(
		...
		return PlayerApiFp(this.configuration)
			.getTheUsersCurrentlyPlayingTrack(market, additionalTypes, options)
			.then((request) => request(this.axios, this.basePath));
	}
 ...
 * @export
 */
export const PlaylistsApiAxiosParamCreator = function (
	configuration?: Configuration,
) {
	return {
		/**
		...
		addTracksToPlaylist: async (
			...
			const localVarPath = `/playlists/{playlist_id}/tracks`.replace(
				`{${"playlist_id"}}`,
				encodeURIComponent(String(playlistId)),
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		 ...
		 * @throws {RequiredError}
		 */
		checkIfUserFollowsPlaylist: async (
			playlistId: string,
			ids: string,
			options: AxiosRequestConfig = {},
		): Promise<RequestArgs> => {
			...
			const localVarPath =
				`/playlists/{playlist_id}/followers/contains`.replace(
					`{${"playlist_id"}}`,
					encodeURIComponent(String(playlistId)),
				);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		...
		followPlaylist: async (
			...
			const localVarPath = `/playlists/{playlist_id}/followers`.replace(
				`{${"playlist_id"}}`,
				encodeURIComponent(String(playlistId)),
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		 ...
		 * @throws {RequiredError}
		 */
		getPlaylistCover: async (
			playlistId: string,
			options: AxiosRequestConfig = {},
		): Promise<RequestArgs> => {
			// verify required parameter 'playlistId' is not null or undefined
			assertParamExists("getPlaylistCover", "playlistId", playlistId);
			const localVarPath = `/playlists/{playlist_id}/images`.replace(
				`{${"playlist_id"}}`,
				encodeURIComponent(String(playlistId)),
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		 ...
		 * @throws {RequiredError}
		 */
		reorderOrReplacePlaylistsTracks: async (
			playlistId: string,
			uris?: string,
			requestBody?: { [key: string]: any },
			options: AxiosRequestConfig = {},
		 ...
		 * @throws {RequiredError}
		 */
		uploadCustomPlaylistCover: async (
			playlistId: string,
			body: string,
			options: AxiosRequestConfig = {},
		): Promise<RequestArgs> => {
	...
	return {
		...
		async addTracksToPlaylist(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<ReorderOrReplacePlaylistsTracks200Response>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.addTracksToPlaylist(
					playlistId,
					position,
					uris,
					requestBody,
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.checkIfUserFollowsPlaylist(
					playlistId,
					ids,
					options,
				);
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.followPlaylist(
					playlistId,
					requestBody,
					options,
				);
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getFeaturedPlaylists(
					country,
					locale,
					timestamp,
					limit,
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getListUsersPlaylists(
					userId,
					limit,
					offset,
					options,
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getPlaylist(
					playlistId,
					market,
					fields,
					additionalTypes,
		...
		async getPlaylistCover(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<Array<ImageObject>>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getPlaylistCover(
					playlistId,
					options,
				);
			return createRequestFunction(
		...
		async getPlaylistsTracks(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<PagingPlaylistTrackObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getPlaylistsTracks(
					playlistId,
					market,
					fields,
					limit,
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.removeTracksPlaylist(
					playlistId,
					removeTracksPlaylistRequest,
					options,
				);
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.reorderOrReplacePlaylistsTracks(
					playlistId,
					uris,
					requestBody,
					options,
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.unfollowPlaylist(
					playlistId,
					options,
				);
			return createRequestFunction(
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.uploadCustomPlaylistCover(
					playlistId,
					body,
					options,
				);
...
export const PlaylistsApiFactory = function (
	...
	return {
		...
		checkIfUserFollowsPlaylist(
			...
			return localVarFp
				.checkIfUserFollowsPlaylist(playlistId, ids, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Create a playlist for a Spotify user. (The playlist will be empty until you [add tracks](/documentation/web-api/reference/add-tracks-to-playlist).)
		...
		followPlaylist(
			...
			return localVarFp
				.followPlaylist(playlistId, requestBody, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get a list of Spotify playlists tagged with a particular category.
		...
		getListUsersPlaylists(
			...
			return localVarFp
				.getListUsersPlaylists(userId, limit, offset, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get a playlist owned by a Spotify user.
		...
		uploadCustomPlaylistCover(
			...
			return localVarFp
				.uploadCustomPlaylistCover(playlistId, body, options)
				.then((request) => request(axios, basePath));
		},
	};
};
...
export class PlaylistsApi extends BaseAPI {
	...
	public getPlaylist(
		...
		return PlaylistsApiFp(this.configuration)
			.getPlaylist(playlistId, market, fields, additionalTypes, options)
			.then((request) => request(this.axios, this.basePath));
	}
...
export const SearchApiAxiosParamCreator = function (
	...
	return {
		...
		search: async (
			...
			if (type) {
				localVarQueryParameter["type"] = type.join(
	...
	return {
		...
		async search(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<Search200Response>
		> {
...
export class SearchApi extends BaseAPI {
	...
	public search(
		...
		return SearchApiFp(this.configuration)
			.search(q, type, market, limit, offset, includeExternal, options)
			.then((request) => request(this.axios, this.basePath));
	}
}
 ...
 * @export
 */
export const ShowsApiAxiosParamCreator = function (
	configuration?: Configuration,
) {
	return {
		/**
		...
		getAShow: async (
			...
			const localVarPath = `/shows/{id}`.replace(
				`{${"id"}}`,
				encodeURIComponent(String(id)),
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
	...
	return {
		...
		async getAShow(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<ShowObject>
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.getAShow(
				id,
				market,
				options,
			);
		...
		async getMultipleShows(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<GetMultipleShows200Response>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getMultipleShows(
					ids,
					market,
					options,
				);
 ...
 * @export
 */
export const ShowsApiFactory = function (
	configuration?: Configuration,
	basePath?: string,
	axios?: AxiosInstance,
) {
	...
	return {
		...
		getMultipleShows(
			...
			return localVarFp
				.getMultipleShows(ids, market, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get a list of shows saved in the current Spotify user\'s library. Optional parameters can be used to limit the number of shows returned.
...
export class ShowsApi extends BaseAPI {
	 ...
	 */
	public checkUsersSavedShows(ids: string, options?: AxiosRequestConfig) {
		return ShowsApiFp(this.configuration)
			.checkUsersSavedShows(ids, options)
			.then((request) => request(this.axios, this.basePath));
	}
 ...
 * @export
 */
export const TracksApiAxiosParamCreator = function (
	configuration?: Configuration,
) {
	return {
		/**
		...
		getAudioAnalysis: async (
			...
			const localVarPath = `/audio-analysis/{id}`.replace(
				`{${"id"}}`,
				encodeURIComponent(String(id)),
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		...
		getAudioFeatures: async (
			...
			const localVarPath = `/audio-features/{id}`.replace(
				`{${"id"}}`,
				encodeURIComponent(String(id)),
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		...
		getRecommendations: async (
			...
			if (targetAcousticness !== undefined) {
				localVarQueryParameter["target_acousticness"] =
					targetAcousticness;
			}
			...
			if (targetDanceability !== undefined) {
				localVarQueryParameter["target_danceability"] =
					targetDanceability;
			}
			...
			if (minInstrumentalness !== undefined) {
				localVarQueryParameter["min_instrumentalness"] =
					minInstrumentalness;
			}

			if (maxInstrumentalness !== undefined) {
				localVarQueryParameter["max_instrumentalness"] =
					maxInstrumentalness;
			}

			if (targetInstrumentalness !== undefined) {
				localVarQueryParameter["target_instrumentalness"] =
			...
			if (targetSpeechiness !== undefined) {
				localVarQueryParameter["target_speechiness"] =
					targetSpeechiness;
			}
			...
			if (targetTimeSignature !== undefined) {
				localVarQueryParameter["target_time_signature"] =
					targetTimeSignature;
			}
		...
		getTrack: async (
			...
			const localVarPath = `/tracks/{id}`.replace(
				`{${"id"}}`,
				encodeURIComponent(String(id)),
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
	...
	return {
		...
		async getAudioAnalysis(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<AudioAnalysisObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getAudioAnalysis(id, options);
			return createRequestFunction(
				localVarAxiosArgs,
				globalAxios,
				BASE_PATH,
		...
		async getAudioFeatures(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<AudioFeaturesObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getAudioFeatures(id, options);
			return createRequestFunction(
				localVarAxiosArgs,
				globalAxios,
				BASE_PATH,
		...
		async getRecommendations(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<RecommendationsObject>
		> {
			const localVarAxiosArgs =
		...
		async getSeveralAudioFeatures(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<GetSeveralAudioFeatures200Response>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getSeveralAudioFeatures(
					ids,
					options,
				);
			return createRequestFunction(
		...
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getSeveralTracks(
					ids,
					market,
					options,
				);
		...
		async getTrack(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<TrackObject>
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.getTrack(
				id,
				market,
				options,
			);
...
export const TracksApiFactory = function (
	...
	return {
		...
		getSeveralAudioFeatures(
			...
			return localVarFp
				.getSeveralAudioFeatures(ids, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get Spotify catalog information for multiple tracks based on their Spotify IDs.
		...
		getSeveralTracks(
			...
			return localVarFp
				.getSeveralTracks(ids, market, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get Spotify catalog information for a single track identified by its unique Spotify ID.
	...
	return {
		...
		async getCurrentUsersProfile(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<PrivateUserObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getCurrentUsersProfile(options);
			return createRequestFunction(
				localVarAxiosArgs,
				globalAxios,
				BASE_PATH,
		...
		async getUsersProfile(
			...
			(
				axios?: AxiosInstance,
				basePath?: string,
			) => AxiosPromise<PublicUserObject>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getUsersProfile(
					userId,
					options,
				);
			return createRequestFunction(
...
export const UsersApiFactory = function (
	...
	return {
		...
		getCurrentUsersProfile(options?: any): AxiosPromise<PrivateUserObject> {
			return localVarFp
				.getCurrentUsersProfile(options)
				.then((request) => request(axios, basePath));
		},
		/**
		 * Get the current user\'s followed artists.
